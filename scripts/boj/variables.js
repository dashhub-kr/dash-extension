/* --------------------------------------------------------------------------
   Global Variables for Baekjoon Hub
   -------------------------------------------------------------------------- */

/*
   Included Variables:
   - languages: Mapping of BOJ languages to file extensions.
   - bj_level: Mapping of Solved.ac levels (0-31) to string representations.
   - RESULT_CATEGORY: Enum for result types.
   - RESULT_MESSAGE: Enum for result messages.
   - uploadState: State object to track upload status.
*/

// BOJ Supported Languages
const languages = {
  "아희": "aheui",
  "엄준식": "umm",
  "Ada": "ada",
...
const RESULT_CATEGORY = {
  ...
  RESULT_DELETED: "del",
  // English version keys mapped to same values or used for checks
  RESULT_ENG_PENDING: "Pending",
  RESULT_ENG_PENDING_REJUDGE: "Rejudge Wait",
  RESULT_ENG_NO_JUDGE: "No Judge",
  RESULT_ENG_PREPARE_FOR_JUDGE: "Preparing for Judging",
  RESULT_ENG_JUDGING: "Judging",
  RESULT_ENG_ACCEPTED: "Accepted",
  RESULT_ENG_PARTIALLY_ACCEPTED: "Partially Accepted",
  RESULT_ENG_PRESENTATION_ERROR: "Presentation Error",
  RESULT_ENG_WRONG_ANSWER: "Wrong Answer",
  RESULT_ENG_ACCEPTED_NOT_CORRECT: "Accepted Not Correct",
  RESULT_ENG_TIME_LIMIT_EXCEEDED: "Time Limit Exceeded",
  RESULT_ENG_MEMORY_LIMIT_EXCEEDED: "Memory Limit Exceeded",
  RESULT_ENG_OUTPUT_LIMIT_EXCEEDED: "Output Limit Exceeded",
  RESULT_ENG_RUNTIME_ERROR: "Runtime Error",
  RESULT_ENG_COMPILATION_ERROR: "Compilation Error",
};
